...
public:
    ...
    virtual TraceEventFmtContent* GetTraceEventFmt() = 0;
    virtual TraceCmdLinesContent* GetTraceCmdLines() = 0;
    virtual TraceTgidsContent* GetTraceTgids() = 0;
...
public:
    ...
    TraceEventFmtContent* GetTraceEventFmt() override;
    TraceCmdLinesContent* GetTraceCmdLines() override;
    TraceTgidsContent* GetTraceTgids() override;
